...
const OrgApplications = () => {
  ...
  const SEEN_KEY = "institution_seen_application_ids_scholarship_org";
  ...
  const filteredApplications = useMemo(() => {
    ...
    return applications.filter((a) => {
      if (q) {
        ...
        const schol = (a.scholarship?.title || a.scholarshipTitle || "").toLowerCase();
        if (!name.includes(q) && !schol.includes(q)) return false;
      }
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Review and manage applications for your scholarships</p>
          </div>
        </div>
          ...
          <CardContent>
            <Table>
              ...
              <TableBody>
                {isLoading ? (
                  <TableRow>
                     <TableCell colSpan={6} className="text-center py-10 text-muted-foreground">Loading applications...</TableCell>
                  </TableRow>
                ) : (
                filteredApplications.map((app) => (
                  ...
                  >
                    ...
                    <TableCell>{app.scholarship?.title || app.scholarshipTitle || "—"}</TableCell>
